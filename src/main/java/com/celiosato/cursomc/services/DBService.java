...
import com.celiosato.cursomc.domain.enums.Perfil;
...
import com.celiosato.cursomc.repositories.ItemPedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat3 = new Categoria(null, "Cama, mesa e banho e toalha");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "mago70@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363326", "93838393"));
		
		Cliente cli2 = new Cliente(null, " Ana Costa", "celiosato4@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
